    ...
    <section id="projects" className="w-full py-24 bg-gray-900/97">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-12">
          ...
          {/* Project 1 */}
          <div
            className="w-full max-w-xs flex flex-col items-center justify-center mx-auto bg-blue-400 rounded-lg shadow-lg overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl"
            data-aos="fade-up"
            data-aos-delay="100"
          >
            <img
              src="/logos/cloudy.png"
              alt="Weather App"
              className="w-[80px] h-[80px] object-contain mt-4"
            />
          ...
          >
            <img
              src="/logos/users-solid.svg"
              alt="Employee Management System"
              className="w-[70px] h-[70px] object-contain mt-4"
            />
            <div className="p-6 text-center">
